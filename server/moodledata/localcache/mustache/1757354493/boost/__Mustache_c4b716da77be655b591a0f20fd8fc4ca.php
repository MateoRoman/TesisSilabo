...
class __Mustache_c4b716da77be655b591a0f20fd8fc4ca extends Mustache_Template
{
...
';
        $value = $context->find('hasactionlinks');
        $buffer .= $this->section034278873daff277210e592c3733a89d($context, $indent, $value);
    ...
    private function sectionE43970c9ca86ff5a55f22edf30995ede(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section034278873daff277210e592c3733a89d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $value = $context->find('modid');
                $buffer .= $this->sectionE43970c9ca86ff5a55f22edf30995ede($context, $indent, $value);
                $value = $context->find('modid');
                if (empty($value)) {
