...
class __Mustache_7a52cebb3c374e6e43a38c5df7d0565b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'headeractions' => array($this, 'blockB2b5dfc60330f4a23b6b4fb98a1fbcbe'),
...
';
    ...
    public function blockB2b5dfc60330f4a23b6b4fb98a1fbcbe($context)
    {
        $indent = $buffer = '';
...
';
        ...
        $buffer .= $indent . '            <span aria-live="polite" class="sr-only" data-region="notification-read-feedback"></span>
';
        $buffer .= $indent . '        </a>
';
